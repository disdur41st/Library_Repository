...
class IndexView(TemplateView):
    ...
    #LibraryEmployee.objects.create (name = "Иван", patronymic_name = "Сергеевич", surname = "Кочин", position = "секретарь")
    #LibraryEmployee.objects.create (id = 2, name = "Фёдор", patronymic_name = "Петрович", surname = "Мерков", position = "библиотекарь")
    #LibraryEmployee.objects.create (id = 3, name = "Лариса", patronymic_name = "Константиновна", surname = "Никифорова", position = "библиотекарь")
